...
- **`index.html`** — Home page. Hero with `01 · Zuhause.` kicker, gallery image placeholders, two pillar blocks: RITMO Padel Club (Community & Events) + RITMO Facility Consulting (Konzept / Bau / Betrieb), and a contact CTA.
